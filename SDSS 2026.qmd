...
- **Extensions of FPCA:**
  ...
  - **Two-way functional data:** Two-way functional data consist of a data matrix whose row and column domains are both structured. Observations vary along these two domains (e.g., time × frequency), with applications in climate science, neuroscience, etc. Huang [@twoway_huang] applied regularization to both left and right singular vectors in SVD.
...
- Conditional GCV criteria [@twoway_huang]:  
    ```{=latex}
    \vspace{-4mm}
  \small
\[
...
## Acknowledgments {noframenumbering=true}
```{=latex}
...
## Appendix {noframenumbering=true}
\textcolor{TitleBlue}{Variance Explained: Classical vs Regularized FPCA}
...
\textcolor{TitleBlue}{Subspace-Projection Definition of Explained Variance}
...
- Orthogonal projector matrix onto span $(v_1,\dots,v_J)$:
  $$
...
## Appendix {noframenumbering=true}
\textcolor{TitleBlue}{PVE, Incremental PVE, and Properties}
