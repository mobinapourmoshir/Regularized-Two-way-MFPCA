...
- **Tuning:**  
  - $\alpha_u$, $\boldsymbol{\alpha}_v$ → control **<span style="color:#b30000;">smoothness</span>** of scores and loadings. 
  - $\gamma_u$, $\boldsymbol{\gamma}_v$ → control **<span style="color:#0033cc;">sparsity</span>** of scores and loadings.
  - Conditional tuning alternates CV for <span style="color:#0033cc;">sparsity</span> and GCV for <span style="color:#b30000;">smoothness</span> to achieve an optimal balance.
