...
#grid(
  columns: 2,
  gutter: 6pt, // adjust spacing between columns

  // Column 1: Functional
  image("images/funcTrue.svg", width: 5.5in),
  image("images/RegTrue.svg", width: 5.5in),
  image("images/funcReco.svg", width: 5.5in),

  // Column 2: Regular
  image("images/RegNoisy.svg", width: 5.5in),
  image("images/funcNoisy.svg", width: 5.5in),
  image("images/RegReco.svg", width: 5.5in),
)
```
